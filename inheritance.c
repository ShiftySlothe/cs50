...
person *create_family(int generations)
{
    ...
    if (generations > 1)
    {
        ...
        _person -> parents[0] = create_family(generations - 1);
    ...
    else
    {
        ...
        _person -> parents[0] = NULL;
        _person -> parents[1] = NULL;
        //Randomly assign alleles
        _person -> alleles[0] = random_allele();
        _person -> alleles[1] = random_allele();
    }
